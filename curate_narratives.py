...
Outputs:
  output/ksc_curated.json          — All narratives with quality scores
  output/ksc_curated_tier1.json    — Tier 1 only (for Gem upload — precision over volume)
  output/narrative_curation_report.md
"""
