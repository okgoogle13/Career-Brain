...
====================================================
Converts all source documents in source_docs/ into plain .txt files
in processed/. No summarizing, redacting, or semantic processing.
