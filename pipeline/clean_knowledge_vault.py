...
third-party articles from source_docs/knowledge/ to enforce a 
...
KNOWLEDGE_DIR = BASE / "source_docs" / "knowledge"
ARCHIVE_DIR = BASE / "archive" / "archive_third_party"
OUTPUT_DIR = BASE / "database"
