...
Moves source files from CLEANUP/ into raw_docs/
...
def main():
    ...
    log.append("\n=== raw_docs/knowledge/ [from AI Knowledge Files] ===")
    ...
    log.append("\n=== raw_docs/knowledge/ [from CUSTOM GEM REFERENCE STUFF] ===")
    ...
    log.append("\n=== raw_docs/knowledge/ [from Chromebook Downloads — selected only] ===")
